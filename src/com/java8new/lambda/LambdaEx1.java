...
public class LambdaEx1 {
    public static void main(String[] args) {
        ...
        ar=ar.stream().filter(data->data%2==0).collect(Collectors.toCollection(ArrayList::new));

        System.out.println(ar);

        /*ArrayList<Integer> ar1=ar.stream().filter(data->data%2==0).collect(Collectors.toCollection(ArrayList::new));
